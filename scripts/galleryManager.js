		...
		var Gallery = (function() {
			...
			function createPGallery() {
				...
				jQuery(".flexslider").each(function(index){				  
				    ...
				    var gallery = "<span class='gallery'><a href='#' onclick=\"var images=["+galleryImgs+"]; var titles=["+imageTitles+"]; var descriptions=["+imageDesc+"]; jQuery.prettyPhoto.open(images,titles,descriptions);\"><img src="+galleryImgs[0]+""+width+height+" /></a></span>";
