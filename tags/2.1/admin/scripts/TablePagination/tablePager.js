 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../wp-content/plugins/reflex-gallery/admin/scripts/TablePagination/images/firstBlue.gif",  
			prevArrow : (new Image()).src="../wp-content/plugins/reflex-gallery/admin/scripts/TablePagination/images/prevBlue.gif",
			lastArrow : (new Image()).src="../wp-content/plugins/reflex-gallery/admin/scripts/TablePagination/images/lastBlue.gif",
			nextArrow : (new Image()).src="../wp-content/plugins/reflex-gallery/admin/scripts/TablePagination/images/nextBlue.gif",
			rowsPerPage : 5,
			currPage : 1,
